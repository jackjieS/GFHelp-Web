...
namespace LoginTest.Login.Bilibili
{
    class Client
    {
        ...
        public string Login()
        {
            ...
            stringArray = new string[] {"app_id","c", "channel_id", "domain", "domain_switch_count", "dp", "game_id", "isRoot", "merchant_id", "model", "net", "operators", "pf_ver", "platform_type", "pwd","sdk_log_type", "sdk_type", "sdk_ver", "server_id", "support_abis", "timestamp", "udid","user_id", "ver", "version" };
            platfromInfo.setSign(stringArray);
            ...
            result = NetBase.DoPost(platfromInfo.LoginURL, data.ToString());
