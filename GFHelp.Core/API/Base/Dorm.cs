...
namespace GFHelp.Core.API
{
    public class Dorm
    {
        ...
        public Dorm(MulitePlayerData.AuthCode AuthCode, BaseRequset BaseRequset)
        {
            this.AuthCode = AuthCode;
            this.BaseRequset = BaseRequset;
        }
        public  string ClickGirlsFavor(GameAccount gameAccount, int dorm_id, int gun_with_user_id)
        {
        ...
        public  string Get_Friend_BattaryNum(GameAccount gameAccount,int f_userid)
        {
        ...
        public  string Get_Friend_Battary(GameAccount gameAccount,int v_user_id, int dorm_id)
        {
            System.Threading.Thread.Sleep(2000);
        ...
        public  string Get_Build_Coin(GameAccount gameAccount,string v_user_id, string dorm_id)
        {
        ...
        public  string getDataCell(GameAccount gameAccount)
        {
            ...
            string url = gameAccount.GameHost + Helper.URL.getDataCell;
            string result = "";
        ...
        public  string WeeklyShare(GameAccount gameAccount)
        {
            string outdatacode = AuthCode.Encode(gameAccount.sign, gameAccount.sign);//用自身作为密匙把自身加密
            string requeststring = String.Format("uid={0}&signcode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
            string url = gameAccount.GameHost + Helper.URL.WeeklyShare;
            string result = "";
            while (string.IsNullOrEmpty(result))
            {
                result =  BaseRequset.DoPost(url, requeststring);
        ...
        public  string DataAnalysisFinishAll(GameAccount gameAccount)
        {
            string outdatacode = AuthCode.Encode(gameAccount.sign, gameAccount.sign);//用自身作为密匙把自身加密
            string requeststring = String.Format("uid={0}&signcode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
            string url = gameAccount.GameHost + Helper.URL.DataAnalysisFinishAll;
            string result = "";
            while (string.IsNullOrEmpty(result))
            {
                result =  BaseRequset.DoPost(url, requeststring);
        ...
        public  string DataAnalysis(GameAccount gameAccount, string outdatacode)
        {
            outdatacode = AuthCode.Encode(outdatacode, gameAccount.sign);
            string requeststring = String.Format("uid={0}&outdatacode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
            string url = gameAccount.GameHost + Helper.URL.DataAnalysis;
            string result = "";
            while (string.IsNullOrEmpty(result))
            {
                result =  BaseRequset.DoPost(url, requeststring);
        ...
        public  string GetFriend_DormInfo(GameAccount gameAccount)
        {
            string outdatacode = AuthCode.Encode(gameAccount.sign, gameAccount.sign);//用自身作为密匙把自身加密
            string requeststring = String.Format("uid={0}&signcode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
        ...
        public  string Establish_Build(GameAccount gameAccount,string outdatacode)
        {
            outdatacode = AuthCode.Encode(outdatacode, gameAccount.sign);
            string requeststring = String.Format("uid={0}&outdatacode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
        ...
        public  string Establish_Build_Finish(GameAccount gameAccount, string outdatacode)
        {
            outdatacode = AuthCode.Encode(outdatacode, gameAccount.sign);
            string requeststring = String.Format("uid={0}&outdatacode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
        ...
        public  string Friend_visit(GameAccount gameAccount, string outdatacode)
        {
            outdatacode = AuthCode.Encode(outdatacode, gameAccount.sign);
            string requeststring = String.Format("uid={0}&outdatacode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
            string url = gameAccount.GameHost + Helper.URL.Visit_Friend_Build;
        ...
        public  string Friend_praise(GameAccount gameAccount, string outdatacode)
        {
            outdatacode = AuthCode.Encode(outdatacode, gameAccount.sign);
            string requeststring = String.Format("uid={0}&outdatacode={1}&req_id={2}", gameAccount.uid, System.Web.HttpUtility.UrlEncode(outdatacode), gameAccount.req_id++.ToString());
